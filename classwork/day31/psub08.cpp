...
protected:
	...
	int age;
public:
	Person(string s, string n, char g, int a) :ssn(n), name(n), gender(g), age(a) {
...
private:
	...
	string e_desg;
public:
	Employee(string ssn, string n, char g, int age, int id, float sal, string desg) :Person(ssn, n, g, age),
		e_id(id), e_sal(sal), e_desg(desg) {
